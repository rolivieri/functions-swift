...
// bx wsk action create --kind swift:3.1.1 action2 Action2.swift --web true
...
// https://openwhisk.ng.bluemix.net/api/v1/web/roliv%40us.ibm.com_dev/default/action2.json
// https://openwhisk.ng.bluemix.net/api/v1/web/roliv%40us.ibm.com_dev/default/action2.http
